...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/start_%s.png" xpos 9 ypos 810 focus_mask True action [Play("sound", "audio/click.mp3"), Start()] hovered [ Play("sound", "audio/hovered.mp3")]
        ...
        imagebutton auto "gui/info_%s.png" xpos 1668 ypos 810 focus_mask True action [Play("sound", "audio/click.mp3"), ShowMenu("about")] hovered [ Play("sound", "audio/hovered.mp3")]
...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            imagebutton auto "images/beta_testers/niki_%s.png" xpos 80 ypos 80 focus_mask True action [Play("sound", "audio/quack.mp3")] hovered [ Play("sound", "audio/hovered.mp3")]
            imagebutton auto "images/beta_testers/kyton_%s.png" xpos 80 ypos 80 focus_mask True action [Play("sound", "audio/quack.mp3")] hovered [ Play("sound", "audio/hovered.mp3")]
